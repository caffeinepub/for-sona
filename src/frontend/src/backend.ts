...
import type { DraftVersion as _DraftVersion, PublicVersion as _PublicVersion, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createDraftVersion(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createDraftVersion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteDraftVersion(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteDraftVersion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDraftVersion(arg0: bigint): Promise<DraftVersion | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDraftVersion(arg0);
    ...
    async getLatestPublicMessage(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestPublicMessage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLiveVersion(): Promise<PublicVersion | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLiveVersion();
    ...
    async listDraftVersions(): Promise<Array<DraftVersion>> {
        if (this.processError) {
            try {
                const result = await this.actor.listDraftVersions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async promoteDraftToLive(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.promoteDraftToLive(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPublicMessage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPublicMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DraftVersion]): DraftVersion | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PublicVersion]): PublicVersion | null {
    return value.length === 0 ? null : value[0];
}
